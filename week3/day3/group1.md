...
| 姓名   | 笔记完成内容                                                 | 录音完成内容 | 遇到的问题                                         | 地址                                                 |
| :----- | ------------------------------------------------------------ | ------------ | -------------------------------------------------- | ---------------------------------------------------- |
|陈龙|复用fragment与空间slideingTablayout等方便完成操作|完成|特殊布局用得少|https://github.com/IFragments?tab=repositories|
|熊国杰|复用fragment与空间slideingTablayout等方便完成操作|完成|无|https://github.com/xb19960925?tab=repositories|
